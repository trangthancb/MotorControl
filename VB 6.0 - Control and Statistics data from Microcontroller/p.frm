...
Begin VB.Form Form1 
   ...
   Begin VB.Frame Frame1 
      ...
      Top             =   0
      Width           =   3615
      Begin ComctlLib.ProgressBar pro_seach_com 
         Height          =   435
         Left            =   105
         TabIndex        =   53
         Top             =   840
...
Private Declare Function SendMessage Lib "user32" Alias "PostMessageA" (ByVal hwnd As Long, ByVal wMsg As Long, ByVal wParam As Long, lParam As Any) As Long
Private Declare Function PostMessage Lib "user32" Alias "PostMessageA" (ByVal hwnd As Long, ByVal wMsg As Long, ByVal wParam As Long, ByVal lParam As Long) As Long
Private Const WM_KEYDOWN = &H100
Private Const WM_KEYUP = &H101
Const VK_UP = &H26
Const VK_DOWN = &H28
Dim WinHwnd, ExHwnd As Long
...
Private Sub MSComm1_OnComm()
    ...
    End If
    If kytunhan = "#" Then
        WinHwnd = FindWindow("screenClass", vbNullString)
        ExHwnd = FindWindowEx(WinHwnd, 0&, "paneClassDC", vbNullString)
        If ExHwnd <> 0 Then
            SendMessage ExHwnd, WM_KEYDOWN, VK_UP, 0&
            SendMessage ExHwnd, WM_KEYUP, VK_UP, 0&
        Else
            txt_Vdat = txt_Vdat - 200
            If txt_Vdat < 1600 Then txt_Vdat = 1600
            cmd_setV_Click
        End If
        Exit Sub
    End If
    If kytunhan = "%" Then
        ...
        ExHwnd = FindWindowEx(WinHwnd, 0&, "paneClassDC", vbNullString)
        If ExHwnd <> 0 Then
            SendMessage ExHwnd, WM_KEYDOWN, VK_DOWN, 0&
            SendMessage ExHwnd, WM_KEYUP, VK_DOWN, 0&
        Else
            txt_Vdat = txt_Vdat + 200
            If txt_Vdat > 2200 Then txt_Vdat = 2200
            cmd_setV_Click
        End If
        Exit Sub
    End If
...
Private Sub hienthi_dothi()
    ...
    Case 1
        ...
        If CStr(Val(s(0))) <> 0 Then
            ...
            TChart1.Series(2).AddXY temp_tocdo, CStr(Round(Val(s(1)) * 500, 0)), "", vbBlue
            temp_tocdo = temp_tocdo + 1
            'Label6.Caption = CStr(Val(s(1)) * 500)
        End If
        rs_kind = 0
        rs_giatri = ""
    Case 2
